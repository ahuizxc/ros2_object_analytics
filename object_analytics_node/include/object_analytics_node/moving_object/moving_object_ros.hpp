...
#include "object_analytics_node/moving_object/moving_objects.hpp"
#include "object_analytics_node/moving_object/param.hpp"
...
{
public:
  OBJECT_ANALYTICS_NODE_PUBLIC MovingObjectRos();
private:
  ...
  using FilteredPolicy =
      message_filters::sync_policies::ApproximateTime<DetectionMsg, TrackingMsg, LocalizationMsg>;
